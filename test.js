...
test('main', async (t) => {t.is(getType(pify(fixture)().then), "function");
...
test('module support - transforms only members in options.include', (t) => {
  ...
  });t.is(getType(pModule.method1().then), "function");t.is(getType(pModule.method2().then), "function");t.not(getType(pModule.method3().then), "function");
...
test('module support — function modules', (t) => {
  const pModule = pify(fixture4);t.is(getType(pModule().then), "function");t.is(getType(pModule.meow().then), "function");
...
test('module support — function modules exclusion', (t) => {
  const pModule = pify(fixture4, {
    excludeMain: true
  });t.is(getType(pModule.meow().then), "function");
...
test('class support — transforms inherited methods', (t) => {
  ...
  t.is(instance.value1, pInstance.value1);t.is(getType(pInstance.instanceMethod1().then), "function");t.is(getType(pInstance.method1().then), "function");t.is(getType(pInstance.parentMethod1().then), "function");t.is(getType(pInstance.grandparentMethod1().then), "function");
...
test('class support - transforms only members in options.include, copies all', (t) => {
  ...
  });t.is(getType(pInstance.parentMethod1().then), "function");
...
test('class support - doesn\'t transform members in options.exclude', (t) => {
  ...
  t.not(typeof pInstance.grandparentMethod1(() => {}).then, 'function');t.is(getType(pInstance.parentMethod1().then), "function");
...
test('class support - options.include over options.exclude', (t) => {
  ...
  });t.is(getType(pInstance.method1().then), "function");t.is(getType(pInstance.parentMethod1().then), "function");
